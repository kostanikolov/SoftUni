...
import military_elite.contracts.LeutenantGeneral;
import military_elite.contracts.Private;
...
public class LeutenantGeneralImpl extends PrivateImpl implements LeutenantGeneral {
    ...
    public String toString() {
        ...
        for (Private privateSoldier : sortedPrivates) {
            leutenantGeneral.append(System.lineSeparator()).append("  ").append(privateSoldier);
        }
